...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--path_rct_to_temps", type=Path, default="data/rct_to_temps.pickle"
    )
    parser.add_argument(
        "--path_temp_to_rcts", type=Path, default="data/temp_to_rcts.pickle"
    )
    parser.add_argument(
    ...
    for template_idx, template_str in tqdm(
        enumerate(template_strs), total=len(template_strs)
    ):
